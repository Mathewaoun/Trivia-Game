...
async function loadQuestion(){ 
    const APIUrl = 'https://opentdb.com/api.php?amount=20&category=9&difficulty=medium';        //This line declares a constant variable named APIUrl and assigns it the URL of an API endpoint
...
function checkAnswer() {
    ...
    if (_options.querySelector('.selected')) {                                                  //This condition checks if the user has selected an answer.
        ...
        if (selectedAnswer == HTMLDecode(correctAnswer)) {                                      //It checks if the user's answer matches the correct answer.
            correctScore+=3;                                                                    //Increment the score by 2
